...
export default class FcmService {
  ...
  createNoitificationListeners = (onNotification, onOpenNotification) => {
    ...
    //   if (remoteMessage) {
    //     console.log('remoteMessage', remoteMessage?.data?.token);
    //     if (remoteMessage?.data?.token) {
    //       let callerImage = remoteMessage?.data?.doctorAvatar1
    //         ? `${IMAGE_PATH1}${remoteMessage?.data?.doctorAvatar}`
    //         : `https://ui-avatars.com/api/?name=MeshApp.Ai&background=0D8ABC&color=fff`;
    //       let infoText = remoteMessage?.data?.body1
    //         ? `${remoteMessage?.data?.body}`
    //         : 'Incomming Call';
    //       this.setData(remoteMessage?.data);
    //       if (Platform.OS === 'android') {
    //         console.log('android incomingCall');
    ...
    //     this.setData(remoteMessage?.data);
    //     console.log("backgroundhandler remoteMessage",remoteMessage);
        
    //     if (Platform.OS === 'android') {
    //       console.log("backgroundhandler incomming call android");
