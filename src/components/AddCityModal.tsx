...
export default function AddCityModal({ visible, onClose, onConfirm }: any) {
    return (
        <Modal
            visible={visible}
            animationType="fade"
            ...
            <TouchableOpacityView
                ...
                <View style={styles.modalContent}>
                    ...
                    <AppText
                        ...
                        {"Please add City from Profile => Edit Profile to continue."}
                    </AppText>
                    ...
                    <View style={styles.buttonRow}>
                        ...
                        <TouchableOpacityView style={styles.deleteButton} onPress={onConfirm}>
                            <AppText weight={SEMI_BOLD} color={WHITE}>Add City</AppText>
                        </TouchableOpacityView>
                    </View>
                </View>
            </TouchableOpacityView>
