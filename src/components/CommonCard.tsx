...
//         )}
//       </View>
//       {vendorName && <AppText weight={MEDIUM}>{vendorName}</AppText>}
//       {shortDesc && (
//         <AppText type={TEN} weight={MEDIUM} color={PLACEHOLDER}>
//           {shortDesc}
//         </AppText>
//       )}

//       <AppText
//         style={{ width: status ? '80%' : '100%', marginVertical: vs(4) }}
//         color={PLACEHOLDER}
//       >
    ...
    <View style={styles.card}>
      ...
      {(htmlContent || description) ? (
        <View style={styles.rowContainer}>
          ...
          {price ? (
            <View style={styles.priceRow}>
              <AppText weight={BOLD} type={FOURTEEN} color={BLACK}>
                {`Rs. ${price}`}
              </AppText>
...
const styles = StyleSheet.create({
  ...
  viewButton1: (disabled: boolean) => ({
    marginTop: vs(20),
    backgroundColor: disabled ? colors.disabledBtn : colors.buttonText,
    borderRadius: ms(20),
    paddingVertical: vs(10),
    flex: 1,
    alignItems: 'center',
