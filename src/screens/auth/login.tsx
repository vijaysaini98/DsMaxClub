...
import { AppText, BOLD, EIGHTEEN, FOURTEEN, MEDIUM, PLACEHOLDER, SEMI_BOLD, SIXTEEN, THIRTEEN, TWENTY_EIGHT, WHITE } from '@components/AppText';
import { colors } from '@theme/colors';
import { authBg, emailIcon, eyeCloseIcon, eyeOpenIcon, logoImage, phoneIcon } from '@helper/imagesAssets';
        ...
        <AppSafeAreaView
            ...
            <KeyBoardAware style={styles.container}>
                <View style={styles.heading}>
                    ...
                    <AppText type={TWENTY_EIGHT} weight={BOLD}>Login</AppText>
                    {userType !== "2" ?
                        ...
                        :
                        <AppText type={EIGHTEEN} style={{ marginTop: 26, textAlign: 'center' }}>
                            {isPhoneNumber ? `We're happy to see you again. \n Enter your phone number` : `We're happy to see you again. \n Enter your email address`}
                        </AppText>
                    }
                </View>
                ...
                <TouchableOpacityView
                    ...
                    <AppText type={EIGHTEEN} color={WHITE} weight={SEMI_BOLD}>{`${userType == "2" ? "SEND OTP" : "LOG IN"}`}</AppText>
                </TouchableOpacityView>
                {userType == "2" &&
                    <TouchableOpacityView
                        onPress={() => {
                        ...
                        <AppText type={FOURTEEN} color={PLACEHOLDER} weight={MEDIUM}>{`${!isPhoneNumber ? "LOGIN WITH PHONE" : "LOGIN WITH EMAIL"}`}</AppText>
                    </TouchableOpacityView>
                }
